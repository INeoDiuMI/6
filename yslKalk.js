function updatePrice() {
  ...
  if( select.value == "1"){ radioDiv.style.display = "none";} 
  if( select.value == "2"){ radioDiv.style.display = "block";} 
  if( select.value == "3"){ radioDiv.style.display = "none";} 
  ...
  checkDiv.style.display = (select.value == "1" ? "none" : "none");
